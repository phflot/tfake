""" ode in the inherited augmentations is modified from torchvision 0.13.1+cu113 """
...
class RandomHorizontalLandmarkFlip(T.RandomHorizontalFlip):
    """Randomly flips images horizontally along with corresponding landmarks."""
...
class RandomNoise(torch.nn.Module):
    """Applies uniform random noise to an image."""
...
class RandomResizedCropLandmark(T.RandomResizedCrop):
    """Randomly crops and resizes images along with corresponding landmarks."""
...
class RandomShearLandmark(T.RandomAffine):
    """Applies random shear transformations to images along with corresponding landmarks."""
...
class RandomRotLandmark(T.RandomAffine):
    """Applies random rotation transformations to images along with corresponding landmarks."""
...
class LandmarkAugmentor:
    """Augmentation pipeline for images and their corresponding landmarks."""
    def __init__(self):
    ...
    def __call__(self, img, lm):
        ...
        # TODO: fix left and right landmarks for flipping augmentation:
...
class ThermalRandomJitter(torch.nn.Module):
    """Applies random jitter to normalized thermal images."""
...
class ThermalRandomInversion(torch.nn.Module):
    """Randomly inverts thermal images."""
...
class ThermalLandmarkAugmentor:
    """Augmentation pipeline specifically for thermal images and their landmarks."""
...
class ImageAugmentor:
    """Augmentation pipeline for general images."""
    def __init__(self):
...
class ThermalAugmentor:
    """Thermal image augmentation pipeline."""
...
class GeometricLandmarkAugmentor:
    """Geometric augmentation pipeline for images and their corresponding landmarks."""
...
class JointLandmarkAugmentor:
    """Joint temperature / rgb augmentation pipeline for thermal and RGB images with landmarks."""
    def __init__(self):
...
class ResizeAugmentor:
    """Resizes thermal and RGB images to a specified output shape."""
