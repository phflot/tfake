...
The main file is "thermalization.py". We used Python 3.10.13 for thermalization.
The Jupyter Notebook displays training progress of our model.
...
The dataset classes are provided and the code should run given paths to the (properly formatted) datasets. 
